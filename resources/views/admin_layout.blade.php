                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="{{URL::to('/add-product-sale')}}">Thêm sản phẩm giảm giá</a></li>
                                    <li><a href="{{URL::to('/all-product')}}">Hiển thị sản phẩm</a></li>
                                    <li><a href="{{URL::to('/all-product-sale')}}">Hiển thị sản phẩm giảm giá</a></li>
                                </ul>
                            </li>
                            <li class="sub-menu">
                                <a href="javascript:;">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a href="typography.html">Thêm bài viết</a></li>
                                    <li><a href="glyphicon.html">Hiển thị bài viết</a></li>
                                </ul>
                            </li>
